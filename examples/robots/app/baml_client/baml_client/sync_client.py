...
class BamlSyncClient:
    ...
    def AnalyzeRobotsTxt(self, content: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="AnalyzeRobotsTxt", args={
                "content": content,
            })
...
class BamlStreamClient:
    ...
    def AnalyzeRobotsTxt(self, content: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.RobotsSummary, types.RobotsSummary]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="AnalyzeRobotsTxt", args={
            "content": content,
        })
        return baml_py.BamlSyncStream[stream_types.RobotsSummary, types.RobotsSummary](
          result,
...
class BamlHttpRequestClient:
    ...
    def AnalyzeRobotsTxt(self, content: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="AnalyzeRobotsTxt", args={
            "content": content,
        }, mode="request")
        return result
